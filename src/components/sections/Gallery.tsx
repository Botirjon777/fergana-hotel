...
export function Gallery() {
  ...
  return (
    <section id="gallery" className="px-5 py-[80px] md:px-12 md:py-[120px] bg-sand overflow-hidden relative">
      <div className="max-w-[1200px] mx-auto mb-16">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 md:gap-20">
          <div className="flex-1">
            ...
            <h2 className="font-cormorant text-[clamp(40px,6vw,72px)] font-light leading-[1] text-text-dark">
              {t("throughOur")} <br />
          ...
          <div className="max-w-[450px] pb-2">
            ...
            <p className="text-text-mid text-[15px] font-light leading-relaxed">
              Discover our curated selection of suites and halls, each designed with a unique blend of comfort and weightless elegance.
            </p>
          </div>
        </div>
      </div>
          ...
          {roomCategories.map((item) => (
            <SwiperSlide key={item.id}>
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/95 via-black/40 to-transparent md:hidden"></div>
                
                {/* Content */}
                <div className="absolute inset-0 p-8 md:p-10 flex flex-col justify-end text-white z-10 drop-shadow-md">
                  <div className="overflow-hidden mb-1 md:mb-2">
                    <span className="text-[10px] tracking-[5px] uppercase text-gold md:group-hover:text-white transition-colors duration-500 block md:transform md:translate-y-full md:group-hover:translate-y-0 transition-transform duration-500">
                      Room Type
                    </span>
                  </div>
                  ...
                  <div className="mt-4 md:mt-6 flex items-center gap-3 md:opacity-0 md:group-hover:opacity-100 transition-all duration-500 md:translate-y-4 md:group-hover:translate-y-0 md:delay-200">
                    ...
                    <span className="text-[9px] md:text-[10px] tracking-[2px] uppercase font-medium">Explore Gallery</span>
                  </div>
                </div>
              </div>
            </SwiperSlide>
