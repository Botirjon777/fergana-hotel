...
export function AvailabilityModal() {
  ...
  return (
    <Modal isOpen={isOpen} onClose={closePopup} type="full">
      <div className="bg-[#1a1108] w-full h-full md:h-auto md:max-w-200 relative overflow-hidden border-none md:border md:border-gold/20 md:shadow-2xl flex flex-col">
        {/* Header */}
