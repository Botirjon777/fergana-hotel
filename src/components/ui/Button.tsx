...
export function Button({
  ...
  const variants = {
    gold: "bg-gold text-white border border-gold hover:bg-[#b08d4a] hover:border-[#b08d4a] hover:translate-y-[-2px] shadow-lg shadow-gold/20 disabled:bg-gold/40 disabled:border-gold/0 disabled:translate-y-0",
    creamy:
