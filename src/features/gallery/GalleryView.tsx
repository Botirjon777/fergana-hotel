...
export default function GalleryView() {
    ...
    <section className="pb-20 px-4 md:px-6">
      <div className="max-w-[1400px] mx-auto">
        <div className="flex items-center gap-6 mb-10">
          <h2 className="font-cormorant text-3xl md:text-5xl text-text-dark">
            {title}
          </h2>
            ...
            .map((src, index) => (
              ...
              >
                <Image
                  ...
                  alt={categoryLabel}
                  fill
                  loading={isPrioritySection && index === 0 ? "eager" : "lazy"}
  ...
  return (
    <main className="bg-cream min-h-screen">
      ...
      {/* Sections */}
      {renderSection(t("sections.hotel"), generalGallery, "Safir Hotel", true)}
      {conferenceCategory &&
        conferenceCategory.images &&
        renderSection(
          t("sections.conference"),
          conferenceCategory.images,
          "Conference Hall",
        )}
