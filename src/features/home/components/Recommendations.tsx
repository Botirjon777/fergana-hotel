...
export function Recommendations() {
  ...
  return (
    <section className="py-10 md:py-16 px-5 bg-cream">
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="overflow-hidden">
          ...
          >
            ...
            <SwiperSlide className="!h-auto flex pb-2">
              <Link
                href="/rooms"
                className="flex flex-col bg-gold overflow-hidden group hover:bg-[#b08d4a] transition-all duration-700 w-full h-full p-8 md:p-10 justify-center items-center text-center text-white relative shadow-[0_20px_40px_rgba(176,113,55,0.2)] min-h-[350px] animate-[fadeUp_0.8s_ease-out_forwards]"
        ...
        <div className="flex items-center justify-center gap-4 mt-8">
          <button
            ...
            className="w-12 h-12 flex items-center justify-center rounded-full border border-gold/30 text-gold hover:bg-gold hover:text-white hover:border-gold transition-all duration-300 active:scale-95"
